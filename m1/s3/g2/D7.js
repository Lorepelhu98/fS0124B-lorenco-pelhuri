...
*/
function concatenarestringhe(stringa1, stringa2){
...
*/
function filtroNumeriPari(array){
...
function incrementaArray(arr, n){
  let nuovoArray = arr.map(valore => valore + n);
...
function lunghezzaStringhe(arr){
  let lunghezze = arr.map(stringa => stringa.length);
